    ...
    public class MonsterObject : MapObject
    {
            ...
            switch (monsterInfo.AI)
            {
                ...
                case 22:
                    return new ZumaKing
                    {
                        ...
                        SpawnList =
                        {
                            {SEnvir.MonsterInfoList.Binding.First(delegate(MonsterInfo x) {return x.Flag == MonsterFlag.ZumaArcherMonster;}), 50},
                            {SEnvir.MonsterInfoList.Binding.First(delegate(MonsterInfo x) {return x.Flag == MonsterFlag.ZumaFanaticMonster;}), 25},
                            {SEnvir.MonsterInfoList.Binding.First(delegate(MonsterInfo x) {return x.Flag == MonsterFlag.ZumaGuardianMonster;}), 25},
                            {SEnvir.MonsterInfoList.Binding.First(delegate(MonsterInfo x) {return x.Flag == MonsterFlag.ZumaKeeperMonster;}), 1},
                        }
                    };
                case 23:
                ...
                case 43:
                    return new ArchLichTaedu
                    {
                        ...
                        SpawnList =
                        {
                            {SEnvir.MonsterInfoList.Binding.First(delegate(MonsterInfo x) {return x.Flag == MonsterFlag.BoneArcher;}), 90},
                            {SEnvir.MonsterInfoList.Binding.First(delegate(MonsterInfo x) {return x.Flag == MonsterFlag.BoneSoldier;}), 15},
                            {SEnvir.MonsterInfoList.Binding.First(delegate(MonsterInfo x) {return x.Flag == MonsterFlag.BoneBladesman;}), 15},
                            {SEnvir.MonsterInfoList.Binding.First(delegate(MonsterInfo x) {return x.Flag == MonsterFlag.BoneCaptain;}), 15},
                            {SEnvir.MonsterInfoList.Binding.First(delegate(MonsterInfo x) {return x.Flag == MonsterFlag.SkeletonEnforcer;}), 1},
                        }
                    };
                case 44:
                    ...
                    {
                        MonsterInfo = monsterInfo,
                        SpawnList = { {SEnvir.MonsterInfoList.Binding.First(delegate(MonsterInfo x) {return x.Flag == MonsterFlag.LesserWedgeMoth;}), 1 }}
                    };
                case 45:
                ...
                case 74:
                    return new BanyoLordGuzak
                    {
                        ...
                        SpawnList =
                        {
                            {SEnvir.MonsterInfoList.Binding.First(delegate(MonsterInfo x) {return x.Flag == MonsterFlag.BanyoCaptain;}), 2},
                        }
                    };
                case 75:
                    ...
                    {
                        MonsterInfo = monsterInfo,
                        SpawnList = { {SEnvir.MonsterInfoList.Binding.First(delegate(MonsterInfo x) {return x.Flag == MonsterFlag.MatureEarwig;}), 1} }
                    };
                case 76:
                    return new DepartedMonster
                    {
                        MonsterInfo = monsterInfo,
                        SpawnList = { {SEnvir.MonsterInfoList.Binding.First(delegate(MonsterInfo x) {return x.Flag == MonsterFlag.GoldenArmouredBeetle;}), 1 }}
                    };
                case 77:
                    return new EnragedLordNiJae
                    {
                        MonsterInfo = monsterInfo,
                        SpawnList = { {SEnvir.MonsterInfoList.Binding.First(delegate(MonsterInfo x) {return x.Flag == MonsterFlag.Millipede;}), 1} },
                        MaxMinions = 200,
                    };
                case 78:
                ...
                case 80:
                    return new SunFeralWarrior
                    {
                        ...
                        SpawnList =
                        {
                            {SEnvir.MonsterInfoList.Binding.First(delegate(MonsterInfo x) {return x.Flag == MonsterFlag.FerociousFlameDemon;}),5},
                            {SEnvir.MonsterInfoList.Binding.First(delegate(MonsterInfo x) {return x.Flag == MonsterFlag.FlameDemon;}),1},
                        }
                    };
                case 81:
                ...
                case 91:
                    return new EnragedArchLichTaedu
                    {
                        ...
                        SpawnList =
                        {
                            {SEnvir.MonsterInfoList.Binding.First(delegate(MonsterInfo x) {return x.Flag == MonsterFlag.GoruArcher;}), 10},
                            {SEnvir.MonsterInfoList.Binding.First(delegate(MonsterInfo x) {return x.Flag == MonsterFlag.GoruGeneral;}),5},
                            {SEnvir.MonsterInfoList.Binding.First(delegate(MonsterInfo x) {return x.Flag == MonsterFlag.GoruSpearman;}),5},
                        }
                    };
                case 92:
                ...
                case 100:
                 ...
                 case 101:
                     return new DragonQueen
                     {
                         ...
                         SpawnList =
                         {
                             {SEnvir.MonsterInfoList.Binding.First(delegate(MonsterInfo x) {return x.Flag == MonsterFlag.OYoungBeast;}), 2},
                             {SEnvir.MonsterInfoList.Binding.First(delegate(MonsterInfo x) {return x.Flag == MonsterFlag.YumgonWitch;}), 2},
                             {SEnvir.MonsterInfoList.Binding.First(delegate(MonsterInfo x) {return x.Flag == MonsterFlag.MaWarden;}), 2},
                             {SEnvir.MonsterInfoList.Binding.First(delegate(MonsterInfo x) {return x.Flag == MonsterFlag.MaWarlord;}), 2},
                             {SEnvir.MonsterInfoList.Binding.First(delegate(MonsterInfo x) {return x.Flag == MonsterFlag.JinhwanSpirit;}), 2},
                             {SEnvir.MonsterInfoList.Binding.First(delegate(MonsterInfo x) {return x.Flag == MonsterFlag.JinhwanGuardian;}), 2},
                             {SEnvir.MonsterInfoList.Binding.First(delegate(MonsterInfo x) {return x.Flag == MonsterFlag.OyoungGeneral;}), 2},
                             {SEnvir.MonsterInfoList.Binding.First(delegate(MonsterInfo x) {return x.Flag == MonsterFlag.YumgonGeneral;}), 2},
                         }
                     };
                 case 102:
                     return new DragonLord { MonsterInfo = monsterInfo,
                         SpawnList =
                         {
                             {SEnvir.MonsterInfoList.Binding.First(delegate(MonsterInfo x) {return x.Flag == MonsterFlag.OYoungBeast;}), 10000},
                             {SEnvir.MonsterInfoList.Binding.First(delegate(MonsterInfo x) {return x.Flag == MonsterFlag.YumgonWitch;}), 10000},
                             {SEnvir.MonsterInfoList.Binding.First(delegate(MonsterInfo x) {return x.Flag == MonsterFlag.MaWarden;}), 10000},
                             {SEnvir.MonsterInfoList.Binding.First(delegate(MonsterInfo x) {return x.Flag == MonsterFlag.MaWarlord;}), 10000},
                             {SEnvir.MonsterInfoList.Binding.First(delegate(MonsterInfo x) {return x.Flag == MonsterFlag.JinhwanSpirit;}), 10000},
                             {SEnvir.MonsterInfoList.Binding.First(delegate(MonsterInfo x) {return x.Flag == MonsterFlag.JinhwanGuardian;}), 10000},
                             {SEnvir.MonsterInfoList.Binding.First(delegate(MonsterInfo x) {return x.Flag == MonsterFlag.OyoungGeneral;}), 10000},
                             {SEnvir.MonsterInfoList.Binding.First(delegate(MonsterInfo x) {return x.Flag == MonsterFlag.YumgonGeneral;}), 10000},

                             {SEnvir.MonsterInfoList.Binding.First(delegate(MonsterInfo x) {return x.Flag == MonsterFlag.DragonLord;}), 1},
                         }
                     };
                case 103:
                ...
                case 115:
                    return new SamaProphet
                    {
                        ...
                        SpawnList =
                        {
                            {SEnvir.MonsterInfoList.Binding.First(delegate(MonsterInfo x) {return x.Flag == MonsterFlag.SamaSorcerer;}), 1},
                        }
                    };
                case 116:
                ...
                case 122:
                    return new QuartzTurtleSub
                    {
                        ...
                        SpawnList =
                        {
                            {SEnvir.MonsterInfoList.Binding.First(delegate(MonsterInfo x) {return x.Flag == MonsterFlag.QuartzMiniTurtle;}), 2},
                        }
                    };
                case 123:
                    return new Larva
                ...
                case 124:
                    return new QuartzTree
                    {
                        ...
                        SpawnList =
                        {
                            {SEnvir.MonsterInfoList.Binding.First(delegate(MonsterInfo x) {return x.Flag == MonsterFlag.QuartzBlueBat;}), 20},
                            {SEnvir.MonsterInfoList.Binding.First(delegate(MonsterInfo x) {return x.Flag == MonsterFlag.QuartzPinkBat;}), 20},
                            {SEnvir.MonsterInfoList.Binding.First(delegate(MonsterInfo x) {return x.Flag == MonsterFlag.QuartzBlueCrystal;}), 20},
                            {SEnvir.MonsterInfoList.Binding.First(delegate(MonsterInfo x) {return x.Flag == MonsterFlag.QuartzRedHood;}), 2},
                        }
                    };
                case 125:
                ...
                case 126:
                    return new MonasteryBoss
                    {
                        ...
                        SpawnList =
                        {
                            {SEnvir.MonsterInfoList.Binding.First(delegate(MonsterInfo x) {return x.Flag == MonsterFlag.Sacrafice;}), 1},
                        }
                    };
                case 127:
        ...
        public override void RefreshStats()
        {
            ...
            if (SummonLevel > 0)
            {
                ...
                Stats[Stat.MinMR] += Stats[Stat.MinMR] * SummonLevel / live_rate;
                Stats[Stat.MaxMR] += Stats[Stat.MaxMR] * SummonLevel / live_rate;

                Stats[Stat.MinDC] += Stats[Stat.MinDC]*SummonLevel / attack_rate;
                Stats[Stat.MaxDC] += Stats[Stat.MaxDC]*SummonLevel / attack_rate;

                Stats[Stat.MinMC] += Stats[Stat.MinMC]*SummonLevel / attack_rate;
                Stats[Stat.MaxMC] += Stats[Stat.MaxMC]*SummonLevel / attack_rate;

                Stats[Stat.MinSC] += Stats[Stat.MinSC]*SummonLevel / attack_rate;
                Stats[Stat.MaxSC] += Stats[Stat.MaxSC]*SummonLevel / attack_rate;
        ...
        public virtual void ProcessAI()
        {
            ...
            if (PetOwner != null && PetOwner.Node != null)
            {
                if (Target != null)
                {
        ...
        {
            if (ob == null || Passive || ob == this || ob.Node == null || ob.Dead || !ob.Visible || ob is Guard || ob is CastleLord) return false;
            ...
            switch (ob.Race)
            {
                ...
                case ObjectType.Monster:
                    ...
                    if (mob.PetOwner == null)
                    {
                        ...
                        if (mobTarget == null || mobTarget.Node == null) return false;
...
/*
        ...
        public override Packet GetInfoPacket(PlayerObject ob)
        {
            return new S.ObjectMonster
            {
                ...
                PetOwner = PetOwner != null ? PetOwner.Name : string.Empty,
