...
namespace Zircon.Server.Models.Monsters
{
    public class GhostMage : MonsterObject
    {
        ...
        public override bool CanAttack {get{return Visible && base.CanAttack;}}
        public override bool CanMove {get{return Visible && base.CanMove;}}
        public override bool Blocking { get { return Visible && base.Blocking; } }
