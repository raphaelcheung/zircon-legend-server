...
namespace Zircon.Server.Models
{
    public abstract class MapObject
    {
        ...
        public virtual bool Blocking {get{return !Dead;}}
        ...
        {
            get{
                return !Dead && SEnvir.Now >= ActionTime && SEnvir.Now >= MoveTime && SEnvir.Now > ShockTime && (Poison & PoisonType.Paralysis) != PoisonType.Paralysis && (Poison & PoisonType.WraithGrip) != PoisonType.WraithGrip && Buffs.All(x => x.Type != BuffType.DragonRepulse && x.Type != BuffType.FrostBite);
            }
        }
        ...
        public virtual bool CanAttack 
        {
            get
            {
                return !Dead && SEnvir.Now >= ActionTime && SEnvir.Now >= AttackTime && (Poison & PoisonType.Paralysis) != PoisonType.Paralysis && Buffs.All(x => x.Type != BuffType.DragonRepulse && x.Type != BuffType.FrostBite);
            }
        }
        public virtual bool CanCast
        {
            get
            {
                return !Dead && SEnvir.Now >= ActionTime && SEnvir.Now >= MagicTime && (Poison & PoisonType.Paralysis) != PoisonType.Paralysis && (Poison & PoisonType.Silenced) != PoisonType.Silenced && Buffs.All(x => x.Type != BuffType.DragonRepulse && x.Type != BuffType.FrostBite);
            }
        }
        ...
        public virtual bool CanDataBeSeenBy(PlayerObject ob)
        {
            ...
            switch (Race)
            {
                case ObjectType.Player:
					...
					if (player.Character != null) if (player.Character.Partner != null)
        ...
        public virtual BuffInfo BuffAdd(BuffType type, TimeSpan remainingTicks, Stats stats, bool visible, bool pause, TimeSpan tickRate)
        {
            ...
            switch (type)
            {
                ...
                case BuffType.Transparency:
					...
					if (((PlayerObject)this).Companion != null)
                    if (Race == ObjectType.Player)
                    {
