...
namespace Server.DBModels
{
    ...
    public sealed class AccountInfo : DBObject
    {
        ...
        protected override void OnCreated()
        {
            ...
            buff.Stats.Values.Add(Stat.AvailableHuntGoldCap, 15);
        ...
        protected override void OnLoaded()
        {
            ...
            Stats tmp = new Stats();
            tmp.Values.Add(Stat.AvailableHuntGoldCap, 15);
            Buffs.First(delegate(BuffInfo x) { return x.Type == BuffType.HuntGold; }).Stats = tmp;
        }
