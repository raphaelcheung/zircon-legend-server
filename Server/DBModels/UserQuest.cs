...
namespace Server.DBModels
{
    ...
    public sealed class UserQuest : DBObject
    {
        ...
        [IgnoreProperty]
        public bool IsComplete {get{return Tasks.Count == QuestInfo.Tasks.Count && Tasks.All(x => x.Completed);}}
        ...
        {
            ClientUserQuest tmp = new ClientUserQuest
            {
                Index = Index,
    ...
    public sealed class UserQuestTask : DBObject
    {
        ...
        [IgnoreProperty]
        public bool Completed { get { return Amount >= Task.Amount; } }
